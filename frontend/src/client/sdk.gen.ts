...
export class Places {
    ...
    public static itemsList<ThrowOnError extends boolean = false>(options: Options<PlacesMenuItemsListData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<PlacesMenuItemsListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
