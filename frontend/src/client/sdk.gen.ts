...
import type { AccountsMeListData, AccountsMeListResponses, AuthTokenCreateData, AuthTokenCreateResponses, AuthTokenRefreshCreateData, AuthTokenRefreshCreateResponses, AuthTokenVerifyCreateData, AuthTokenVerifyCreateResponses, CategoriesListData, CategoriesListResponses, CategoriesCreateData, CategoriesCreateResponses, CategoriesDeleteData, CategoriesDeleteResponses, CategoriesReadData, CategoriesReadResponses, CategoriesPartialUpdateData, CategoriesPartialUpdateResponses, CategoriesUpdateData, CategoriesUpdateResponses, KakaomapDistanceListData, KakaomapDistanceListResponses, KakaomapMapListData, KakaomapMapListResponses, KakaomapOptimizeRouteCreateData, KakaomapOptimizeRouteCreateResponses, KakaomapRouteListData, KakaomapRouteListResponses, KakaomapSearchListData, KakaomapSearchListResponses, RoutesListData, RoutesListResponses, RoutesCreateData, RoutesCreateResponses, RoutesCategoriesListData, RoutesCategoriesListResponses, RoutesPreferencesListData, RoutesPreferencesListResponses, RoutesPreferencesCreateData, RoutesPreferencesCreateResponses, RoutesRecommendData, RoutesRecommendResponses, RoutesDeleteData, RoutesDeleteResponses, RoutesReadData, RoutesReadResponses, RoutesPartialUpdateData, RoutesPartialUpdateResponses, RoutesUpdateData, RoutesUpdateResponses, TourismApiRegionalData, TourismApiRegionalResponses, TourismPoisListData, TourismPoisListResponses, TourismPoisReadData, TourismPoisReadResponses, TourismRecommendationRecommendData, TourismRecommendationRecommendResponses, TourismRecommendationRelatedData, TourismRecommendationRelatedResponses, TourismRelatedListData, TourismRelatedListResponses, TourismRelatedReadData, TourismRelatedReadResponses, TravelCoursesListData, TravelCoursesListResponses, TravelCoursesCreateData, TravelCoursesCreateResponses, TravelCoursesDeleteData, TravelCoursesDeleteResponses, TravelCoursesReadData, TravelCoursesReadResponses, TravelCoursesPartialUpdateData, TravelCoursesPartialUpdateResponses, TravelCoursesUpdateData, TravelCoursesUpdateResponses } from './types.gen';
import { zAccountsMeListData, zAuthTokenCreateData, zAuthTokenCreateResponse, zAuthTokenRefreshCreateData, zAuthTokenRefreshCreateResponse, zAuthTokenVerifyCreateData, zAuthTokenVerifyCreateResponse, zCategoriesListData, zCategoriesListResponse, zCategoriesCreateData, zCategoriesCreateResponse, zCategoriesDeleteData, zCategoriesReadData, zCategoriesReadResponse, zCategoriesPartialUpdateData, zCategoriesPartialUpdateResponse, zCategoriesUpdateData, zCategoriesUpdateResponse, zKakaomapDistanceListData, zKakaomapMapListData, zKakaomapOptimizeRouteCreateData, zKakaomapRouteListData, zKakaomapSearchListData, zRoutesListData, zRoutesListResponse, zRoutesCreateData, zRoutesCreateResponse, zRoutesCategoriesListData, zRoutesPreferencesListData, zRoutesPreferencesCreateData, zRoutesRecommendData, zRoutesRecommendResponse, zRoutesDeleteData, zRoutesReadData, zRoutesReadResponse, zRoutesPartialUpdateData, zRoutesPartialUpdateResponse, zRoutesUpdateData, zRoutesUpdateResponse, zTourismApiRegionalData, zTourismApiRegionalResponse, zTourismPoisListData, zTourismPoisListResponse, zTourismPoisReadData, zTourismPoisReadResponse, zTourismRecommendationRecommendData, zTourismRecommendationRecommendResponse, zTourismRecommendationRelatedData, zTourismRecommendationRelatedResponse, zTourismRelatedListData, zTourismRelatedListResponse, zTourismRelatedReadData, zTourismRelatedReadResponse, zTravelCoursesListData, zTravelCoursesListResponse, zTravelCoursesCreateData, zTravelCoursesCreateResponse, zTravelCoursesDeleteData, zTravelCoursesReadData, zTravelCoursesReadResponse, zTravelCoursesPartialUpdateData, zTravelCoursesPartialUpdateResponse, zTravelCoursesUpdateData, zTravelCoursesUpdateResponse } from './zod.gen';
...
export class Accounts {
    public static accountsMeList<ThrowOnError extends boolean = false>(options?: Options<AccountsMeListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<AccountsMeListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
                return await zAccountsMeListData.parseAsync(data);
            },
            security: [
                {
                    name: 'Authorization',
...
export class Kakaomap {
     ...
     */
    public static kakaomapDistanceList<ThrowOnError extends boolean = false>(options?: Options<KakaomapDistanceListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<KakaomapDistanceListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
     ...
     */
    public static kakaomapMapList<ThrowOnError extends boolean = false>(options?: Options<KakaomapMapListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<KakaomapMapListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
     ...
     */
    public static routeCreate<ThrowOnError extends boolean = false>(options?: Options<KakaomapOptimizeRouteCreateData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<KakaomapOptimizeRouteCreateResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
     ...
     */
    public static kakaomapRouteList<ThrowOnError extends boolean = false>(options?: Options<KakaomapRouteListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<KakaomapRouteListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
     ...
     */
    public static kakaomapSearchList<ThrowOnError extends boolean = false>(options?: Options<KakaomapSearchListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<KakaomapSearchListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
...
export class Routes {
     ...
     */
    public static routesCategoriesList<ThrowOnError extends boolean = false>(options?: Options<RoutesCategoriesListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<RoutesCategoriesListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
    ...
    public static routesPreferencesList<ThrowOnError extends boolean = false>(options?: Options<RoutesPreferencesListData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).get<RoutesPreferencesListResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
    ...
    public static routesPreferencesCreate<ThrowOnError extends boolean = false>(options?: Options<RoutesPreferencesCreateData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<RoutesPreferencesCreateResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
     ...
     * }
     */
    public static routesRecommend<ThrowOnError extends boolean = false>(options: Options<RoutesRecommendData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<RoutesRecommendResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
