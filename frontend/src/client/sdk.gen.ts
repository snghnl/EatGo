...
export class Routes {
    ...
    public static routesRecommendationsCreate<ThrowOnError extends boolean = false>(options: Options<RoutesRecommendationsCreateData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<RoutesRecommendationsCreateResponses, unknown, ThrowOnError>({
            requestValidator: async (data) => {
                return await zRoutesRecommendationsCreateData.parseAsync(data);
            },
            responseValidator: async (data) => {
                return await zRoutesRecommendationsCreateResponse.parseAsync(data);
            },
            security: [
                {
                    name: 'Authorization',
