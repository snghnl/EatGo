              ...
              <View style={styles.passwordMatchContainer}>
                <Text
                  style={[
                    ...
                    isPasswordMatch && styles.passwordMatchSuccess,
                  ]}
                >
                  비밀번호 일치
                </Text>
              ...
              <View style={styles.termsBox}>
                ...
                >
                  <View
                    style={[
                      styles.checkbox,
                      form.agreeToAll && styles.checkboxChecked,
                    ]}
                  >
                    {form.agreeToAll && (
                  ...
                  <Text style={styles.termsText}>전체동의</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Pressable hitSlop={8} onPress={() => setOpen("terms")}>
                    <Ionicons
                ...
                >
                  <View
                    style={[
                      styles.checkbox,
                      form.agreeToPrivacy && styles.checkboxChecked,
                    ]}
                  >
                    {form.agreeToPrivacy && (
                      <Ionicons name="checkmark" size={16} color="white" />
                  ...
                  <Pressable hitSlop={8} onPress={() => setOpen("privacy")}>
                    <Ionicons
                      name="chevron-forward"
                      size={16}
                      color="#9CA3AF"
                ...
                >
                  <View
                    style={[
                      styles.checkbox,
                      form.agreeToLocation && styles.checkboxChecked,
                    ]}
                  >
                    {form.agreeToLocation && (
                      <Ionicons name="checkmark" size={16} color="white" />
                  ...
                  <Pressable hitSlop={8} onPress={() => setOpen("location")}>
                    <Ionicons
                      name="chevron-forward"
                      size={16}
                      color="#9CA3AF"
                ...
                <AgreementPopup
                  ...
                  onAgree={() => {
                    if (!form.agreeToTerms) toggleTermsAgreement();
                    setOpen(null);
                  }}
                >
                  <TermsContent />
                ...
                <AgreementPopup
                  ...
                  onClose={() => setOpen(null)}
                  onAgree={() => {
                    if (!form.agreeToPrivacy) togglePrivacyAgreement();
                    setOpen(null);
                  }}
                >
                  <PrivacyContent />
                ...
                <AgreementPopup
                  ...
                  onClose={() => setOpen(null)}
                  onAgree={() => {
                    if (!form.agreeToLocation) toggleLocationAgreement();
                    setOpen(null);
                  }}
                >
                  <LocationContent />
          ...
          >
            <Text
              style={[
                ...
                allRequirementsMet() && styles.signupButtonTextActive,
              ]}
            >
              가입하기
            </Text>
