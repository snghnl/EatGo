...
export default function FoodPreferenceScreen() {
    ...
    const handleNext = () => {
        const selectedCount =
            Object.values(selectedFoods).filter(Boolean).length;
        if (selectedCount === 0) {
            // TODO: 경고 메시지 표시
            return;
        }
                            ...
                            <View style={styles.foodGrid}>
                                ...
                                <View style={styles.row}>
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.korean &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("korean")
                                        }
                                    >
                                    ...
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.western &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("western")
                                        }
                                    >
                                        <View style={styles.foodIcon}>
                                            <Ionicons
                                    ...
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.japanese &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("japanese")
                                        }
                                    >
                                        <View style={styles.foodIcon}>
                                            <Ionicons
                                ...
                                <View style={styles.row}>
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.chinese &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("chinese")
                                        }
                                    >
                                        <View style={styles.foodIcon}>
                                            <Ionicons
                                ...
                                <View style={styles.row}>
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.hamburger &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("hamburger")
                                        }
                                    >
                                        <View style={styles.foodIcon}>
                                            <Ionicons
                                    ...
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.seafood &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("seafood")
                                        }
                                    >
                                        <View style={styles.foodIcon}>
                                            <Ionicons
                                ...
                                <View style={styles.row}>
                                    ...
                                    <TouchableOpacity
                                        style={[
                                            styles.foodButton,
                                            selectedFoods.bakery &&
                                                styles.foodButtonSelected,
                                        ]}
                                        onPress={() =>
                                            toggleFoodSelection("bakery")
                                        }
                                    >
                                        <View style={styles.foodIcon}>
                                            <Ionicons
