...
const MyPageHeader: React.FC<MyPageHeaderProps> = ({ username, neighborCount, profileImageUrl, onPressProfile }) => {
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.profileBlock} onPress={onPressProfile}>
                <Image
                    source={{
                        uri: profileImageUrl || 'https://via.placeholder.com/80x80.png?text=🙂',
                    }}
