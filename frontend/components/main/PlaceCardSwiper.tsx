...
export default function PlaceCardSwiper({
    onClose,
    onPlaceSelect,
    places: propPlaces,
    loading,
    ...
    const handleCardPress = useCallback(
        (place: Place) => {
            ...
            if (place.external_url) {
                Linking.openURL(place.external_url);
            }
                ...
                >
                    ...
                    <View style={styles.infoBlock}>
                        ...
                        <Text style={styles.text} numberOfLines={1}>
                            전화번호:{" "}
                            {place.phone_number || place.phone || "정보 없음"}
                        </Text>
                        <Text style={styles.text} numberOfLines={1}>
                            주소:{" "}
                            {place.road_address || place.road_address_name}
                        </Text>
