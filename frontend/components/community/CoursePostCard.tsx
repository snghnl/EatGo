...
export default function CoursePostCard({ user, post, routeMeta, onPress }: Props) {
    const hasProfileImage = Boolean(user.profile_image_url && user.profile_image_url.trim());
    const router = useRouter();

    return (
        <TouchableOpacity style={styles.container} onPress={() => router.push(`/community/${post.id}`)}>
            {/* 상단 - 유저 정보 */}
