...
export const CreateCourseModal: React.FC<CreateCourseModalProps> = ({
  ...
  const handleDestinationChange: DestinationChangeHandler = (destinations) => {
  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <DestinationSelector onDestinationChange={handleDestinationChange} />
        );
      case 3:
      ...
      >
        <View style={styles.header}>
          <Text style={styles.title}>
            {MODAL_STEP_TITLES[currentStep as keyof typeof MODAL_STEP_TITLES]}
          </Text>
        ...
        <View style={styles.footer}>
          ...
          <TouchableOpacity
            ...
            style={[
              styles.nextButton,
              !isStepComplete(currentStep) && styles.nextButtonDisabled,
            ]}
          ...
          >
            <Text
              style={[
                styles.nextText,
                !isStepComplete(currentStep) && styles.nextTextDisabled,
              ]}
            >
              {currentStep === 3 ? "추천 코스와 함께 계획하러 가기" : "다음"}
            </Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
