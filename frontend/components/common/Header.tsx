...
export default function Header({ align, title, titleColor, subtitle, subtitleColor }: HeaderProps) {
    return (
        <View
            style={[
                styles.container,
        ...
        >
            <View style={[styles.content, { alignItems: align === 'left' ? 'flex-start' : 'center' }]}>
